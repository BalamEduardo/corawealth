...
import { GoalOption, goals } from '@/data/onboarding';
...
export default function OnboardingStep2Screen() {
    ...
    const handleSelectGoal = (goalId: GoalOption | null) => {
        // Haptic feedback
        if (Platform.OS === 'ios') {
                            ...
                            <BlurView intensity={BLUR_INTENSITY.card} tint="light" style={styles.glassCard}>
                                ...
                                <View style={styles.questionSection}>
                                    <Text style={styles.question}>
                                        ¿Cuál es la primera meta que te gustaría lograr con calma?
                                    </Text>
                                    <Text style={styles.subtitle}>
                                        No hay prisa. Lo importante es que tengas claro tu propósito.
                                    </Text>
                                </View>
